...
addEnderAlSm(<thermalfoundation:material:167> * 4, [<thermalfoundation:material:131> * 3, <thermalfoundation:material:134>, <minecraft:ender_pearl> * 4], 50000);
...
addEnderAlSm(<enderio:item_alloy_ingot:6>, [<minecraft:iron_ingot>, <thermalfoundation:material:768>, <thermalfoundation:material:770> * 4], 20000);

// Organic Green Dye
remEnderAlSm(<enderio:item_material:48>);
addEnderAlSm(<enderio:item_material:48> * 2, [<ore:dyeGreen> * 2, <ore:slimeball>, <thermalfoundation:material:768> * 2], 2000);
addEnderAlSm(<enderio:item_material:48> * 2, [<ore:dyeGreen> * 2, <ore:slimeball>, <thermalfoundation:material:769> * 2], 2000);
addEnderAlSm(<enderio:item_material:48>, [<ore:dyeGreen>, <ore:egg>, <thermalfoundation:material:768>], 1500);
addEnderAlSm(<enderio:item_material:48>, [<ore:dyeGreen>, <ore:egg>, <thermalfoundation:material:769>], 1500);

// Organic Brown Dye
remEnderAlSm(<enderio:item_material:49>);
addEnderAlSm(<enderio:item_material:49> * 2, [<ore:dyeBrown> * 2, <ore:slimeball>, <thermalfoundation:material:768> * 2], 2000);
addEnderAlSm(<enderio:item_material:49> * 2, [<ore:dyeBrown> * 2, <ore:slimeball>, <thermalfoundation:material:769> * 2], 2000);
addEnderAlSm(<enderio:item_material:49>, [<ore:dyeBrown>, <ore:egg>, <thermalfoundation:material:768>], 1500);
addEnderAlSm(<enderio:item_material:49>, [<ore:dyeBrown>, <ore:egg>, <thermalfoundation:material:769>], 1500);